...
$current_dir = getcwd(); 
define('SITEURL', 'http://base1.tutorsincity.com/hello');
define('SYSTEMMODE', 'TEST');
define('SYSTEMPATH', dirname(__FILE__));
define('WDIRPATH', $current_dir);
...
include 'include/class.groups.php';  
...
function upload_url($location='') {     
    ...
    $upload_url = site_url('/uploads/'.$location); 
    return $upload_url;
...
if($sengvis==0) {  
    ...
    $filelocation = WDIRPATH.'/'.$robottxtfile;  
    $rbtext = '
User-agent: *
Disallow: /
        '; 
